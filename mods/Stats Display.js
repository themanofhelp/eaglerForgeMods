...
function initializeHud() {
    setTimeout(async function () {
        ...
        thanksContainer.style.boxShadow = "0 0 30px #00ffee";
        thanksContainer.style.backdropFilter = "blur(3px)";
        thanksContainer.style.transition = "opacity 1s ease-in-out";
        ...
        setTimeout(() => {
            ...
            setTimeout(function() {
            document.getElementById('thanksContainer').remove();
            }, 2800);
